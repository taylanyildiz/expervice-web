    ...
    return (
        <Box className="login-page">
            <Grid container justifyContent="center" alignItems="center" direction="column">
                <Grid item children={<Link to={ERouter.Base} children={Images.logoTextWhite({ width: 300 })} />} />
                    ...
                    <Box className="login-box">
                        <Grid container rowSpacing={1} justifyContent="center">
                            ...
                            <Grid item xs={12} mt={3}>
                                <PrimaryButton fullWidth fontWeight="normal" children="Login" backgroundColor={Colors.primaryDark} color="white" />
                            </Grid>
                            <Grid item xs={12} mt={2} justifyContent="center" display="flex">
                                <Typography>
                                    Forgot your <b className="bold-text" onClick={onForgotPasswordHandle}>password</b> ?
                                </Typography>
                            </Grid>
                        </Grid>
                    </Box>
