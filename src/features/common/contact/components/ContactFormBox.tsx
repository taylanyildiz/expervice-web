...
function ContactFormBox() {
    ...
    /// Formik
    const initialValues: ContactForm = { full_name: "", email: "", messages: "", phone: "", subject: "" };
    ...
    return (
        <Grid container rowSpacing={1}>
            <Grid item xs={12} children={<Typography variant="h1" fontSize={20} children="Contact Form" />} />
            <Grid item xs={12} >
                <TextOutlineField
                    fullWidth
                    label="Full Name"
