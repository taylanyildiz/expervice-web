    ...
    return (
        <>
            ...
            <Grid container justifyContent="center" pt={5} px={20} rowSpacing={3}>
                <Grid item px={10} xs={12} children={<Typography variant="h1" textAlign="center" children="The right pricing package for every construction team" />} />
                <Grid item>
                            ...
                            plans.reverse().map((plan, index) => {
                                return <Grid key={plan.id} item>
                                    <PricingBox
                                        ...
                                        permissions={plan?.options?.map(e => e.translations!.name!.en!) ?? []}
                                        onClick={() => { }}
                                    />
                                </Grid>
                            })
